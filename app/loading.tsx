...
export default function LoadingScreen() {
  ...
  const generateItinerary = async () => {
    try {
      ...
      // Merge cost breakdown into preferences when user asked for tickets
      const preferencesWithCost = {
          ...
          .insert([
            {
              ...
              preferences: preferencesWithCost,
              status: 'active',
            },
          ])
          .select()
      ...
      // Update store (include meta and costBreakdown for itinerary tab card)
      const fullItinerary = {
        ...itinerary,
        days: dayRecords,
